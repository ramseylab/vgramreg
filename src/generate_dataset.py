...
def make_xlsx_str(do_log:bool, 
    ...
    if do_log:  log_str = "_log"            # if run with log-transform
    else: log_str = "_NOlog"                # if not use log-transform
    if recenter: recenter_str = "_recenter" # if run with double detilt/ recentering
    else: recenter_str = "_NOrecenter"      # if not recentering
